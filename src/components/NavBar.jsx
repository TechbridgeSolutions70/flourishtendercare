    ...
    <>
        ...
        <div className="top-strip-inner">
          <div className="strip-left">
            <div className="social-links" aria-label="Social links">
              <a href="https://www.facebook.com/flourishtendercare1" target="_blank" rel="noreferrer noopener" className="social-link" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/flourishtendercare1" target="_blank" rel="noreferrer noopener" className="social-link" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/flourishtendercare1" target="_blank" rel="noreferrer noopener" className="social-link" aria-label="LinkedIn">
      ...
      <nav className="topbar">
        ...
        <div className="topbar-actions desktop-only">
          <a className="btn btn-secondary navbar-apply-btn" href="https://portal.flourishtendercare.com.ng/apply" target="_blank" rel="noreferrer">Apply</a>
      ...
      <div className={`mobile-nav ${mobileOpen ? 'open' : ''}`} role="dialog" aria-hidden={!mobileOpen}>
        ...
        <a href="/" onClick={(e) => { e.preventDefault(); window.location.href = '/#news'; setMobileOpen(false); }}>News</a>
        <a href="/" onClick={(e) => { e.preventDefault(); window.location.href = '/#contact'; setMobileOpen(false); }}>Contact</a>
        <a className="btn btn-secondary mobile-nav-btn navbar-apply-btn" href="https://portal.flourishtendercare.com.ng/apply" target="_blank" rel="noreferrer" onClick={() => setMobileOpen(false)}>Apply</a>
